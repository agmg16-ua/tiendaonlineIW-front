...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LewkinTiendaOnline.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new LewkinTiendaOnline.ErrorResponse();
      //expect(instance).to.be.a(LewkinTiendaOnline.ErrorResponse);
    });
