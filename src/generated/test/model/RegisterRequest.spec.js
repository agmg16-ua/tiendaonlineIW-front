...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LewkinTiendaOnline.RegisterRequest();
  });
  ...
  describe('RegisterRequest', function() {
    it('should create an instance of RegisterRequest', function() {
      ...
      //var instance = new LewkinTiendaOnline.RegisterRequest();
      //expect(instance).to.be.a(LewkinTiendaOnline.RegisterRequest);
    });
